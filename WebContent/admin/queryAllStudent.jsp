...
function delStudent(sno) {
	var flag = window.confirm("您确定要删除该机构信息吗？");
	if (flag) {
...
<body>
	...
	<div  style="margin-top:20px; margin-left: 70px;">
		<form action="${pageContext.request.contextPath }/queryCriteriaStudent.do" method="post">
			机构编号：<input type="text" name="sno" style="width:60px" />&nbsp;&nbsp;&nbsp;&nbsp;
			机构名称：<input type="text" name="sname" style="width:60px" />&nbsp;&nbsp;&nbsp;&nbsp;
			性质：<select name="sex" id="sex">
                	<option></option>
                	<option>公营</option>
                	<option>私营</option>
                </select>&nbsp;&nbsp;&nbsp;&nbsp;
			国家：<input type="text" name="sclass" style="width:60px" />&nbsp;&nbsp;&nbsp;&nbsp;
