...
<body>
	...
	<div class="treebox">
		<ul class="menu">
			<!--c:choose 标签可以根据不同的条件完成指定的业务逻辑，如果没有符合的条件会执行默认条件的业务逻辑-->
			<c:choose>
				<c:when test="${person == 'administrator'}">
					...
					<li class="level1"><a href="#none">机构功能<i></i></a>
						<ul class="level2">
							<li><a href="${pageContext.request.contextPath }/queryClass.do" target="right">添加机构</a></li>
							<li><a href="${pageContext.request.contextPath }/queryAllStudent.do" target="right">获取所有机构</a></li>
						</ul></li>  
				...
				<c:when test="${person == 'student'}">
					<li class="level1"><a href="#none">机构功能<i></i></a>
						<ul class="level2">
							<li><a href="../student/queryStudent.jsp" target="right">查看机构信息</a></li>
							<li><a href="${pageContext.request.contextPath }/toSelectCourse.do" target="right">录入课程课 </a></li>
							<li><a href="${pageContext.request.contextPath }/getSelectedCourse.do" target="right">查看已录入课程</a></li>
						</ul>
					</li>
				</c:when>
